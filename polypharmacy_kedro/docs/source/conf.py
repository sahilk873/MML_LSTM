...
# polypharmacy_kedro documentation build
...
from polypharmacy_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "polypharmacy_kedro"
author = "Kedro"
...
htmlhelp_basename = "polypharmacy_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "polypharmacy_kedro.tex",
        "polypharmacy_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "polypharmacy_kedro",
        "Project polypharmacy_kedro codebase.",
        "Data-Science",
    )
]
